...
export default class Knight extends Piece {
  ...
  possibleMoves(squares, currentPosition) {
    ...
    if (this.canMoveUp(currentPosition, 2)) {
      ...
      if (
        this.canMoveLeft(currentPosition, 1) &&
        !this.teamPieceAtSquare(squares, possibleMove)
      ) {
      ...
      if (
        this.canMoveRight(currentPosition, 1) &&
        !this.teamPieceAtSquare(squares, possibleMove)
      ) {
        possibilities.push(possibleMove);
      }
    ...
    if (this.canMoveUp(currentPosition, 1)) {
      ...
      if (
        this.canMoveLeft(currentPosition, 2) &&
        !this.teamPieceAtSquare(squares, possibleMove)
      ) {
        possibilities.push(possibleMove);
      }
      ...
      if (
        this.canMoveRight(currentPosition, 2) &&
        !this.teamPieceAtSquare(squares, possibleMove)
      ) {
        possibilities.push(possibleMove);
      }
