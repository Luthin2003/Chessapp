...
export default class Pawn extends Piece {
  ...
  possibleMoves(squares, currentPosition) {
    ...
    if (
      !(currentPosition % 8 === 0 && possibleMove % 8 === 7) &&
      !(currentPosition % 8 === 7 && possibleMove % 8 === 0) &&
      this.enemyPieceAtSquare(squares, possibleMove)
    ) {
      // console.log("shit");
      // console.log(currentPosition, possibleMove);
      possibilities.push(possibleMove);
    }
